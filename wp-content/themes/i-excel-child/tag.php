...
get_header(); ?>
	...
	<div id="primary" class="content-area searchcontent-area">
        ...
        <div class="crsearch-left">
            ...
            <div class="helpinner helpinner-second"><a href="mailto:info@wheretospendcryptos.com"><button class="crmissing">Tell us what we're missing</button></a></div>
